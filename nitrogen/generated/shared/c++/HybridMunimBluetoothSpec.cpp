...
namespace margelo::nitro::munimbluetooth {
  ...
  void HybridMunimBluetoothSpec::loadHybridMethods() {
    ...
    registerHybrids(this, [](Prototype& prototype) {
      ...
      prototype.registerHybridMethod("refreshGattCache", &HybridMunimBluetoothSpec::refreshGattCache);
      ...
      prototype.registerHybridMethod("getMaximumWriteLength", &HybridMunimBluetoothSpec::getMaximumWriteLength);
      prototype.registerHybridMethod("requestConnectionPriority", &HybridMunimBluetoothSpec::requestConnectionPriority);
