...
namespace margelo::nitro::munimbluetooth {
  ...
  public:
    ...
    static jni::local_ref<JAdvertisingOptions::javaobject> fromCpp(const AdvertisingOptions& value) {
      using JSignature = JAdvertisingOptions(jni::alias_ref<jni::JArrayClass<jni::JString>>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JDouble>, jni::alias_ref<jni::JArrayClass<JManufacturerDataEntry>>, jni::alias_ref<JAdvertisingDataTypes>);
      static const auto clazz = javaClassStatic();
