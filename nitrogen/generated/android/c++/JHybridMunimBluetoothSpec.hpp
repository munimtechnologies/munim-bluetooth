...
namespace margelo::nitro::munimbluetooth {
  ...
  public:
    ...
    void setServices(const std::vector<GATTService>& services, const PeripheralRequestOptions& requestOptions) override;
    ...
    std::shared_ptr<Promise<void>> respondToPeripheralReadRequest(const std::string& requestId, const std::string& value, bool useStoredValue, PeripheralRequestStatus status) override;
    std::shared_ptr<Promise<void>> respondToPeripheralWriteRequest(const std::string& requestId, bool accept, PeripheralRequestStatus status) override;
    ...
    void startScan(const ScanOptions& options) override;
    void stopScan() override;
    std::shared_ptr<Promise<void>> connect(const std::string& deviceId, const ConnectOptions& options) override;
    ...
    std::shared_ptr<Promise<void>> writeCharacteristic(const std::string& deviceId, const std::string& serviceUUID, const std::string& characteristicUUID, const std::string& value, WriteType writeType) override;
    ...
    std::shared_ptr<Promise<bool>> refreshGattCache(const std::string& deviceId) override;
    ...
    std::shared_ptr<Promise<void>> setPreferredPhy(const std::string& deviceId, BluetoothPhy txPhy, BluetoothPhy rxPhy, BluetoothPhyOption phyOption) override;
